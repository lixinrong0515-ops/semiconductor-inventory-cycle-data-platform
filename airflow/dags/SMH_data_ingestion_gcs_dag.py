...
PARQUET_FILE = "SMH_data.parquet"

PARQUET_PATH = f"{AIRFLOW_HOME}/{PARQUET_FILE}"

GCS_OBJECT = f"smh/{PARQUET_FILE}"

TABLE_NAME = "smh_prices"
...
with DAG(
    dag_id="smh_market_data",

    default_args=default_args,

    description=(
        "End-to-end SMH market data ingestion "
        "and dbt transformation pipeline"
    ),
    ...
    download_smh_data = PythonOperator(
        task_id="download_smh_data",
    ...
    upload_smh_to_gcs = PythonOperator(
