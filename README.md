...
flowchart TD
    ...
    A[Yahoo Finance<br/>SMH & S&P 500]
    B[FRED<br/>New Orders / Inventories / PPI]
    ...
    E --> F[BigQuery<br/>Raw External Tables]

    F --> G[dbt Cloud<br/>Production]
    ...
    L[GitHub Actions<br/>CI] --> G
    M[Terraform<br/>Infrastructure as Code] --> E
    M --> F
```
